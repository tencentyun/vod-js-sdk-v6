...
var Uploader = /** @class */ (function (_super) {
    ...
    Uploader.prototype.commitUploadUGC = function (vodSessionKey, retryCount) {
        if (retryCount === void 0) { retryCount = 0; }
        return __awaiter(this, void 0, void 0, function () {
            function whenError(err) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                _a.sent();
                                return [2 /*return*/, self.commitUploadUGC(vodSessionKey, retryCount + 1)];
                        }
                    });
                });
            }
            var self, signature, response, e_2, commitResult, err;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.commitUploadUGC(applyData.vodSessionKey)];
