...
var Uploader = /** @class */ (function (_super) {
    ...
    Uploader.prototype.applyUploadUGC = function (retryCount) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            var self, signature, sendParam, videoInfo, coverInfo, vodSessionKey, response, e_1, applyResult, vodSessionKey_1, err;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
    ...
    Uploader.prototype.uploadToCos = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self, applyData, cosParam, cos, uploadCosParams, cosVideoParam, cosCoverParam, uploadPromises;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
                        return [4 /*yield*/, this.applyUploadUGC()];
                    case 1:
                        applyData = _a.sent();
                        cosParam = {
    ...
    Uploader.prototype.commitUploadUGC = function (retryCount) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            var self, signature, vodSessionKey, response, e_2, commitResult, err;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        self = this;
    ...
    Uploader.prototype._start = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.uploadToCos()];
                    case 1:
                        _a.sent();
